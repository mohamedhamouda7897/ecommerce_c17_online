...
import 'package:ecommerce_c17_online/features/main_layout/favourite/presentation/bloc/wish_bloc.dart';
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: HeartButton(onTap: () {
                            BlocProvider.of<WishBloc>(context).add(
                                  AddProductToWishList(product.id.toString()),
                                );
                          }),
                        ),
                      ],
